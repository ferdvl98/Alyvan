...
<body id="body">
    ...
    <div class="menu__side" id="menu_side">
        ...
        <div class="options__menu">
            ...
            <a href="../historial/historial.php?id=<?php echo $id; ?>" target="workarea" id="histo">
                <div class="option" id="btn_historial">
                    <i class="fas fa-history" title="Historial"></i>
                    <h4>Historial</h4>
                </div>
            </a>
            <a href="main-rutas.php?id=<?php echo $id; ?>" >
                <div class="option" id="btn_historial">
                <i class="fas fa-map" title="Rutas"></i>
                    <h4>Rutas</h4>
                </div>
            </a>
