<?php
    ...
    if(empty(trim($nombre))){
        ...
        switch ($id) {
            case 0:
                $consulta = $link->query("SELECT * FROM cliente where nom_cliente LIKE '%$nombre%'");
                echo "<table border = '1px' align ='center' id = 'tabla' class='display'>
                <tr>
                    <th style='width: 10%'>Código</th>
                    <th style='width: 70%'>Cliente</th>
                ...
                break;
            case 1:
                $consulta = $link->query("SELECT * FROM cedis where nom_cliente LIKE '%$nombre%'");
                echo "<table border = '1px' align ='center' id = 'tabla' class='display'>
                <tr>
                    <th style='width: 10%'>Código</th>
                    <th style='width: 70%'>CEDIS</th>
                ...
                break;
            case 2:
                $consulta = $link->query("SELECT * FROM destinos where nom_cliente LIKE '%$nombre%'");
                echo "<table border = '1px' align ='center' id = 'tabla' class='display'>
                <tr>
                    <th style='width: 10%'>Código</th>
                    <th style='width: 70%'>Destino</th>
